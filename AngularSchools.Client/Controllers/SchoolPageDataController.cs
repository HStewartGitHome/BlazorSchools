...
namespace AngularSchools.Client.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class SchoolPageDataController : CommonController
    {
        private readonly ILogger<SchoolPageDataController> _logger;

        private readonly IConfiguration _configuration;
        public string HtmlClientApi { get; set; }
        public string ErrorString { get; set; }

        public SchoolPageDataController(ILogger<SchoolPageDataController> logger,
